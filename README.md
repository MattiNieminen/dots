...
Disclaimer: Homebrew on Linux or having multiple package managers to choose
from is not my thing at all. But I it is what is is with Atomic distros
currently...
...
Steam is already installed (and configured to use Proton) in Bazzite. Just
login, install some games and start playing.

#### Finishing touches

Open Settings and go to 'Appearance'. Set 'Style' to 'Dark' and choose accent
color. Set wallpaper. Remove unnecessary apps from Dash and add apps which are
used daily.
